...
def main():
    ...
    # dp3.generate_dps(animating_energy=True,
    #                  scrolling=False, dark_bg=True)
    # dp4 = DoublePendulumAnimated(
    #     n=3, fps=200, t_end=3, name="dp4", trace_size=0, variation=pi/3, ic=[3*pi/4, -4, 0, 6])
    # dp4.generate_dps(animating_energy=True,
    #                  scrolling=False, dark_bg=True)
    # dp5 = DoublePendulumAnimated(
    #     n=32, fps=50, t_end=5, name="dp5", trace_size=5, variation=pi/64, ic=[pi/2, 0, pi/2, 0])
    # dp5.generate_dps()
    # dp6 = DoublePendulumAnimated(n=3, name="dp6", trace_size=12, p=[
    #                              2, 3, 5, 7, 11], ic=[pi/4, -2, pi/16, -2])
    # dp6.generate_dps(animating_dp=True, animating_energy=True,
    #                  scrolling=True, dark_bg=True)
    # dp7 = DoublePendulumAnimated(name="dp7", p=[1, 1, 1, 1, -9.8])
    # dp7.generate_dps(animating_energy=True,
